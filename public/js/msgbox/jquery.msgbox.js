        ...
        this.esqueleto.msgbox.queue(this.options.name, $.proxy(function( next ) {
          ...
          if (options.type != 'prompt')
          {
            $.each(buttons, $.proxy(function(i, button) {
              ...
              {
                this.esqueleto.buttons.append($('<button type="submit" class="btn btn-primary">'+button.value+'</button>').bind('click', $.proxy(function(e) { this.close(button.value); e.preventDefault(); }, this)));
              }
              else if (button.type == 'cancel')
              {
                this.esqueleto.buttons.append($('<button type="button" class="btn btn-default">'+button.value+'</button>').bind('click', $.proxy(function(e) { this.close(false); e.preventDefault(); }, this)));
              }
            }, this));
          }
          else if (options.type == 'prompt')
          {
            $.each(buttons, $.proxy(function(i, button) {
              if (button.type == 'submit')
              {
                this.esqueleto.buttons.append($('<button type="submit" class="btn btn-primary">'+button.value+'</button>').bind('click', $.proxy(function(e) {
              ...
              {
                this.esqueleto.buttons.append($('<button type="button" class="btn btn-primary">'+button.value+'</button>').bind('click', $.proxy(function(e) { this.close(false); e.preventDefault(); }, this)));
              };
            }, this));
          };
